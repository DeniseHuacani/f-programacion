...
public class VideoJuego7 {
    ...
    public static void batallaSoldado(Map<Integer,Soldado> ejercito1,Map<Integer,Soldado> ejercito2, int posicion){
        if(ejercito1.get(posicion).getNivelVida()>ejercito2.get(posicion).getNivelVida()){
            System.out.println("Gano : "+ ejercito1.get(posicion).getNombre() );
            System.out.println("El "+ejercito2.get(posicion).getNombre()+" muere");
            ejercito2.remove(posicion);
        }
        else if(ejercito1.get(posicion).getNivelVida()==ejercito2.get(posicion).getNivelVida()){
            int numero= random(2);
            if(numero==1){
                System.out.println("Gano : "+ ejercito1.get(posicion).getNombre() );
                System.out.println("El "+ejercito2.get(posicion).getNombre()+" muere");
